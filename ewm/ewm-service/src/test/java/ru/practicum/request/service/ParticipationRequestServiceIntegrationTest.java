...
public class ParticipationRequestServiceIntegrationTest {
    ...
    public void setUp() {
        ...
        Long userId = userService.create(new NewUserDto("just.bob@bobs.ru","MR.BOBS")).getId();
    ...
    public void testUpdateStatus() {
        ...
        EventRequestStatusUpdateResult result = participationRequestService.updateStatus(partisipantId, eventId, updateRequest);
    ...
    public void testUpdateStatus_NonInitiator() {
        Long anotherUserId = 2L; // Замените на реальный ID другого пользователя
