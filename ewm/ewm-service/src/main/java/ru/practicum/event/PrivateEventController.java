...
public class PrivateEventController {
    ...
    public ResponseEntity<EventFullDto> updateEvent(
        ...
        log.debug("Endpoint PATCH /users/{}/events/{} has been reached with UpdateEventUserRequest: {}",
        ...
        log.info("User`s {} event {} patched successfully",userId,updatedEvent.getId());
